...
class ParkingManagement(BaseSolution):
    ...
    def __init__(self, **kwargs):
        ...
        self.arc = (0, 255, 0)    # available region color (красный)
        self.occ = (0, 0, 255)    # occupied region color (зеленый)
        self.dc = (255, 0, 189)   # centroid color for each box (розовый)
    ...
    def process_data(self, im0):
        ...
        annotator.display_analytics(im0, self.pr_info, (104, 31, 17), (255, 255, 255), 2)
